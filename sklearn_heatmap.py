...
def main():
    ...
    len_scale_bounds = {'0': (long_scale/2, long_scale*100), '2': (long_scale/2, long_scale*100),'0,2': (long_scale/2, long_scale*100)}
    ...
    plotter.plot_heatmap('/Users/natalie/Desktop/heatmap_csvs/combined-2024-06-19x005_Mh24_Loc2.csv',True, gpregressor=tool,
                    transparent = {'var %': 0.95, 'transparency': 0.5}, match_scale=True, latlon = False)
