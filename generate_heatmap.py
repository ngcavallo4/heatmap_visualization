...
def main():
    ...
    len_scale = {'0': 0, '1': 0, '2': 5.2, '3': 0.5, 'all': 10, 2: 0}
    plotter = KrigingPlotter(['0','1'], bin_num = 5, length_scale=len_scale)
    plotter.plot_heatmap('2024-6-18_Mh24_Loc1_Path1_10_12_am_Trial3.csv', True, match_scale = False)
